...
Patch* viewInvPatch1 = new Patch(Call, D2CLIENT, 0x997B2, (int)ViewInventoryPatch1_ASM, 6);//updated 1.13d
Patch* viewInvPatch2 = new Patch(Call, D2CLIENT, 0x98E84, (int)ViewInventoryPatch2_ASM, 6);//updated 1.13d
Patch* viewInvPatch3 = new Patch(Call, D2CLIENT, 0x97E3F, (int)ViewInventoryPatch3_ASM, 5);//updated 1.13d
